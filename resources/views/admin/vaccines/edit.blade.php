...
@section('title', 'Sửa Vắc xin')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1"><i class="bi bi-pencil-square me-2 text-primary"></i>Sửa Vắc xin</h4>
            ...
            <form action="{{ route('admin.vaccines.update', $vaccine) }}" method="POST">
                ...
                <div class="row g-3">
                    <div class="col-md-12">
                        ...
                        <input type="text" name="vaccine_name" class="form-control @error('vaccine_name') is-invalid @enderror" value="{{ old('vaccine_name', $vaccine->vaccine_name) }}" required>
                        @error('vaccine_name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Nhà sản xuất</label>
                        <input type="text" name="manufacturer" class="form-control @error('manufacturer') is-invalid @enderror" value="{{ old('manufacturer', $vaccine->manufacturer) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="doses_required" class="form-control @error('doses_required') is-invalid @enderror" value="{{ old('doses_required', $vaccine->doses_required) }}" min="1" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                            <option value="1" {{ old('status', $vaccine->status) == '1' ? 'selected' : '' }}>Sẵn sàng</option>
                            <option value="0" {{ old('status', $vaccine->status) == '0' ? 'selected' : '' }}>Tạm ngưng</option>
                        </select>
