...
<div class="modal-overlay" id="reviewModal">
    <div class="modal review-modal">
        ...
        <textarea
            id="rm-comment"
            placeholder="Chia sẻ cảm nhận của bạn về bác sĩ, thái độ, chuyên môn... (tuỳ chọn)"
            maxlength="1000"
            rows="4"
        ></textarea>
...
<div class="modal-overlay" id="deleteReviewModal">
    <div class="modal" style="max-width:400px">
        ...
        <div class="modal-btns">
            ...
            <button type="button" class="modal-confirm-btn" id="delete-review-confirm-btn" onclick="confirmDeleteReview()">
                Xóa
            </button>
        </div>
    </div>
...
<div class="modal-overlay" id="replyReviewModal">
    <div class="modal" style="max-width:480px;text-align:left">
        ...
        <textarea
            ...
            maxlength="1000"
            rows="4"
            style="width:100%;padding:12px 14px;background:var(--gray-50);border:1.5px solid var(--gray-200);border-radius:16px;font-family:'Inter',sans-serif;font-size:.82rem;resize:vertical;outline:none;transition:border-color .2s;"
        ></textarea>
        ...
        <div class="modal-btns">
            ...
            <button type="button" class="modal-confirm-btn" style="background:linear-gradient(105deg,var(--primary),#2065cf)"
                onclick="submitReply()">Lưu phản hồi</button>
        </div>
    </div>
</div>
...
{{-- ═══════════════════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════════════════ --}}
<style>
    .review-modal { max-width: 480px; text-align: center; }
    ...
    .review-doctor-name { font-weight: 700; font-size: .9rem; color: var(--gray-800); }
    .review-doctor-dept { font-size: .72rem; color: var(--gray-400); margin-top: 2px; }
    .review-doctor-date { font-size: .72rem; color: var(--primary); margin-top: 2px; font-weight: 600; }
    ...
    .star.active, .star.hover { color: #f59e0b; transform: scale(1.15); }
    ...
    #rm-comment:focus { border-color: var(--primary); background: var(--white); }

    .review-error {
        background: #fef2f2; border: 1px solid #fecaca;
        border-radius: 12px; padding: 10px 14px;
        font-size: .78rem; color: #dc2626; margin-bottom: 14px;
        text-align: left;
    }
    ...
    .reply-original-stars { color: #f59e0b; font-size: 1.1rem; margin-bottom: 4px; }
    .reply-original-comment { font-size: .82rem; color: var(--gray-700); }
</style>
