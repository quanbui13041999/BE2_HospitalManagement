                    ...
                    <div class="card h-100 shadow-sm hover-card border-0 rounded-4 overflow-hidden">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-muted small mb-3">
                                {{ Str::limit($service->description ?? 'Không có mô tả', 80) }}
                            </p>
                    ...
                    <div class="list-group-item p-3">
                        <div class="row align-items-center">
                            <div class="col-md-4">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted">Mã: {{ $service->service_code }}</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <span><i class="bi bi-clock"></i> {{ $service->duration_minutes }} phút</span>
                            </div>
                            <div class="col-md-2">
