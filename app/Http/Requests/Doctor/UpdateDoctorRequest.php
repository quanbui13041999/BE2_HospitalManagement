...
class UpdateDoctorRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'user_id' => [
                ...
                Rule::unique('doctors', 'user_id')->ignore($doctorId, 'doctor_id'),
            ],
            'email' => 'nullable|email|unique:users,email,'.($this->input('user_id') ?? 'NULL').',user_id',
    ...
    public function messages(): array
    {
        return [
            ...
            'version.required' => 'Phiên bản bản ghi không hợp lệ.',
            'version.integer' => 'Phiên bản bản ghi phải là số nguyên.',
            'version.min' => 'Phiên bản bản ghi không hợp lệ.',
        ];
    }
}
