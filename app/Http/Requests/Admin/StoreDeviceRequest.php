...
class StoreDeviceRequest extends FormRequest
{
    ...
    protected const CODE_REGEX = '/^[A-Z]+(?:-[A-Z]+)*-[0-9]+$/';
    ...
    public function messages(): array
    {
        return [
            ...
            'name.regex' => 'Tên thiết bị chỉ được nhập chữ và một khoảng trắng giữa các từ, không nhập số hoặc ký tự lạ.',
            ...
            'code.regex' => 'Mã thiết bị phải đúng định dạng chữ-gạch ngang-số, ví dụ IMG-US-001.',
            ...
            'purchase_date.required' => 'Vui lòng nhập ngày mua thiết bị.',
