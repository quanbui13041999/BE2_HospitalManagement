...
class UpdateMedicalRecordRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'vitals.heart_rate' => ['sometimes', 'required', 'regex:/\A[0-9]+\z/', 'integer', 'min:1', 'max:300'],
            ...
            'vitals.spo2' => ['sometimes', 'required', 'regex:/\A[0-9]+\z/', 'integer', 'min:50', 'max:100'],
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator): void {
            ...
            if ((int) ($user?->role_id ?? 0) === 2 && $this->filled('doctor_id') && $this->integer('doctor_id') !== (int) $user->user_id) {
